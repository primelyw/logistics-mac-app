...
display_stream = [['DISPLAY','-'],['ID', 'CNSS'],['END','-'],['CREATE','-'],['TABLE','-'],['ID','CNSS'],['LP','-'],['ID','ID'],['STRING','-'],['COM','-'],['ID','DIR'],['STRING','-'],['RP','-'],['END','-']]
...
search_stream = [['SEARCH','-'],['FROM','-'],['ID','CNSS'],['WHERE','-'],['SLP','-'],['ID','ID'],['EQ','-'],['STR','primelee'],['COM','-'],['ID','DIR'],['EQ','-'],['STR','pwn'],['SRP','-'],['END','-']]
token_stream = create_stream+delte_stream+add_stream+search_stream+display_stream
